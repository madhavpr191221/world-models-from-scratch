...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        type=str,
        default="validation",
        help="Physical validation split folder name.",
    )
    parser.add_argument(
        "--test-source-split",
        type=str,
        default="test",
        help="Physical test split folder name.",
    )
    ...
    parser.add_argument(
        "--predictors",
        nargs="+",
        default=["causal_transformer", "mamba", "cross_attention"],
...
def main() -> None:
    ...
    for encoder_name in args.encoders:
        ...
        for predictor_name in args.predictors:
            pair_name = f"{encoder_name}-{predictor_name}"
